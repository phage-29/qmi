                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="container-fluid">
                            ...
                            <p>Set up email or SMS notifications for specific events:</p>

                            <form>
                                <div class="mb-3">
                                    <label for="notificationType" class="form-label">Notification Type</label>
                                    <select class="form-select" id="notificationType">
                                        <option selected>Select a notification type</option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="event"
                                        placeholder="Enter the event you want to be notified about">
                                </div>

                                <div class="mb-3">
                                    <label for="notificationRecipient" class="form-label">Notification Recipient</label>
                                    <input type="text" class="form-control" id="notificationRecipient"
                                        placeholder="Enter the email or phone number for notifications">
                                </div>
