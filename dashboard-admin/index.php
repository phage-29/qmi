                                ...
                                <div class="col-md-4">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">Current Queue: Queue 1</p>
                                            <p class="card-text">Total People in Queue: 15</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">Average Wait Time: 10 minutes</p>
                                            <p class="card-text">Total Served Today: 50</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">Important Announcement 1</p>
                                            <p class="card-text">Important Announcement 2</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
