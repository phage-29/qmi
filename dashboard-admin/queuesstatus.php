            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="container-fluid">
                            <h1 class="h3 mb-0 text-gray-800">Queue Status</h1>

                            <!-- View Current Queues -->
                            <section>
                                <h4 class="h3 mb-0 text-gray-800">View Current Queues</h4>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="card mb-3">
                                            <div class="card-body">
                                                <h5 class="card-title">Queue Name</h5>
                                                <p class="card-text">Number of People: 10</p>
                                                <p class="card-text">Expected Wait Time: 30 minutes</p>
                                                <a href="#" class="btn btn-primary">Manage Queue</a>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Repeat the above card for each active queue -->
                                </div>
                            </section>

                            <!-- Queue History -->
                            <section>
                                <h4 class="h3 mb-0 text-gray-800">Queue History</h4>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Queue 1</td>
                                            <td>2023-10-20 10:00 AM</td>
                                            <td>2023-10-20 11:30 AM</td>
                                            <td><a href="#">View Statistics</a></td>
                                            <td><a href="#">Details</a></td>
                                        </tr>
                                        <!-- Repeat the above row for each historical queue -->
                                    </tbody>
                                </table>
                            </section>
                        </div>
