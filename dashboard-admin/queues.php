            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="container-fluid">
                            <h1 class="h3 mb-0 text-gray-800">Manage Queues</h1>
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h6 class="card-title mt-5"><i
                                                    class="me-1 font-18 mdi mdi-numeric-1-box-multiple-outline"></i>Pending
                                                Stundents</h6>
                                            ...
                                            <h6 class="card-title"><i
                                                    class="me-1 font-18 mdi mdi-numeric-2-box-multiple-outline"></i>Already
                                                Claim
                                            </h6>
                                        </div>
                                        <div class="table-responsive">
