                        ...
                        <div class="container-fluid">
                            ...
                            <div class="container mt-5">
                                <div class="row justify-content-center">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form>
                                                            ...
                                                            <!-- Contact Reference Number Input -->
                                                            <div class="form-group">
                                                                <label for="contactNumber">Reference
                                                                    Number:</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card">
                                            <div class="card-header">PERSON TO NOTIFY IN CASE EMERGENCY</div>
                                            <div class="card-body">

                                                <!-- Parents/Guardian Name Input -->
                                                <div class="form-group">
                                                    <label for="lastName">Parents/Guardian Full Name:</label>
                                                    <input type="text" class="form-control" id="lastName"
                                                        placeholder="Enter your full name" required>
                                                </div>


                                                <!-- Contact Parents/Guardian Number Input -->
                                                <div class="form-group">
                                                    <label for="contactNumber">Parents/Guardian Contact
                                                        Number:</label>
                                                ...
                                                <!-- Upload Signature Picture Input -->
                                                <div class="form-group">
                                                    <label for="picture">Upload Signature Picture:</label>
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="picture"
                                                            accept="image/*">
                                                        <label class="custom-file-label" for="picture">Choose
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <img src="../img/footerlogo.png" height="10%" width="100px">
